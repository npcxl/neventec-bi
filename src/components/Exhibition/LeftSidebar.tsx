...
export function ExhibitionLeftSidebar({
  ...
  return (
    <aside className="flex h-full min-h-0 flex-col gap-[clamp(0.6rem,1vw,0.9rem)] xl:gap-3" style={{ background: 'url(/img/bg-diffuse.png) center/contain no-repeat' }}>
      {/* ===== 项目运营总览 ===== */}
        ...
        <div className="relative flex-1 flex flex-col  p-1" style={{ height: 159 }}>
          {loading ? (
            ...
            <>
              {/* 第一行：管理展位总数 */}
              <div
                className="relative flex-1 overflow-hidden rounded-xl bg-[url('/img/exhibition-overview-cards.png')] bg-[length:100%_auto] bg-center bg-no-repeat"
      ...
      <section className="relative flex min-h-0 flex-1 flex-col overflow-hidden">
        ...
        <div className="flex min-h-0 flex-1 flex-col px-[16px] py-[8px]" style={{ width: 448 }}>
          {/* 表头 */}
          <div className="mb-1.5 grid min-w-0 grid-cols-[55px_minmax(0,1fr)_60px_60px_60px] gap-2 rounded-lg px-3 py-2 text-[14px] text-[rgba(255,255,255,0.8)] bg-[url('/img/bg-list.png')] bg-[length:100%_100%]">
              ...
              renderItem={(row, index) => {
                ...
                return (
                  <div
                    ...
                    className={`grid h-full min-w-0 cursor-pointer grid-cols-[55px_minmax(0,1fr)_60px_60px_60px] items-center gap-2 px-3 text-[14px] transition-colors border-b border-dashed border-[#334155] hover:bg-white/[0.08]
                      }`}
                  >
